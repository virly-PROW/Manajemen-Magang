...
// POST - Create notification for siswa role (simple, shared for all)
export async function POST(request: NextRequest) {
  try {
    ...
    // Create single notification for siswa role (shared for all users)
    ...
    console.log(`✅ Successfully created notification for siswa role`)
    ...
    console.error("Create notification for siswa error:", error)
    return NextResponse.json(
