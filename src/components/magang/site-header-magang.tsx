...
export function SiteHeaderMagang() {
  ...
  return (
    <div className="w-full">
        ...
        <div className="inline-flex rounded-md border border-[#dbe7ff] bg-white shadow-sm">
          <button
            onClick={() => {
              ...
              setTimeout(() => {
                if (pathname !== "/siswa/magang") router.push("/siswa/magang")
              }, 50)
            }}
            className={`px-4 py-1 text-sm font-medium transition-all duration-200 rounded-l-md ${
              (role === "siswa" && pathname === "/siswa/magang") || pathname === "/siswa/magang"
      ...
      <div className="px-4 py-3">
        <h2 className="text-2xl font-bold">Siswa Magang</h2>
